    ...
    <div class="flex flex-row h-full">
        <div class="flex-1 flex flex-col h-full pt-52 w-full">
            <div class="flex flex-col px-32">
                ...
                <div class="mt-3 bg-white rounded-md shadow-md px-6 py-3 border border-gray-200 flex flex-col gap-3">
                    ...
                    <div class="flex justify-end w-full">
                        <button
                            class="bg-blue-500 hover:bg-blue-600 focus:outline-none text-white rounded-md py-2 w-32">
                            Sign up
                        </button>
                    </div>

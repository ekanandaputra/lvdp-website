...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #2D76CF 0%, #2678db 100%);
        }
    </style>
</head>
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-transparent lg:bg-transparent text-black p-4 lg:p-0 z-20"
                id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li class="mr-3">
                        <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                            href="#" id="nav-item">Spesification</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                            href="#">Pricing</a>
                ...
                <button id="navAction"
                    class="text-white mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Login
                </button>
            </div>
        </div>
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Let's Monitor Your Power Resources
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    Monitor your power resources anytime and anywhere using Power Meter
                </p>
            </div>
  ...
  -->
    <script>
        ...
        if (scrollpos > 10) {
          ...
          navcontent.classList.add("bg-trasnparent");
        }
      });
    </script>
    <script>
    ...
    <script>
        $(document).on('click', '#navAction', function(event) {
